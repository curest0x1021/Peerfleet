...
class Wires_info_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sql = "SELECT $info_table.files, $wires_table.id as wire_id, $wires_table.client_id, $wires_table.lifts as lifts, $equipments_table.name as crane, $type_table.name as wire, $info_table.id, $info_table.diameter, $info_table.length, $info_table.swl, $info_table.manufacturer_id, $manufacturers_table.name as manufacturer, $info_table.installed, k1.passed as loadtest_passed, k1.test_date, k.passed as visual_inspection_passed, k.inspection_date
                FROM $wires_table
