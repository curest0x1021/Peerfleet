...
class Notifications_model extends Crud_model {
    ...
    function get_notifications($user_id, $offset = 0, $limit = 20) {
        ...
        $sql = "SELECT SQL_CALC_FOUND_ROWS $notifications_table.*, CONCAT($users_table.first_name, ' ', $users_table.last_name) AS user_name, $users_table.image AS user_image,
                 ...
                 $clients_table.charter_name AS company_name, lead_table.charter_name AS lead_company_name,
                 ...
                 (SELECT $clients_table.charter_name FROM $clients_table WHERE $clients_table.id=$notifications_table.lead_id) AS lead_title,
        ...
        LEFT JOIN (SELECT $clients_table.id, $clients_table.charter_name FROM $clients_table) AS lead_table ON lead_table.id=$notifications_table.lead_id
