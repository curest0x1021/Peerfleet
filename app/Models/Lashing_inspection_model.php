...
class Lashing_inspection_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sql = "SELECT CONCAT('#', $lashing_table.no, ' - ', $lashing_table.name) as name, $lashing_table.qty as qty, $lashing_table.id as lashing_id, c.id, c.inspection_date, c.inspected_by, c.location, c.passed, c.remaining, c.discarded, c.remarks
                FROM $lashing_table
                LEFT JOIN (
