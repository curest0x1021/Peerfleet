...
class Clients extends Security_Controller
{
    ...
    function save()
    {
        ...
        $data = array(
            ...
            "net_tonnage" => $this->request->getPost('net_tonnage'),
            "lightweight" => $this->request->getPost('lightweight'),
            "length_over_all" => $this->request->getPost('length_over_all'),
            "length_between_perpendiculars" => $this->request->getPost('length_between_perpendiculars'),
            "length_of_waterline" => $this->request->getPost('length_of_waterline'),
            "breadth_moulded" => $this->request->getPost('breadth_moulded'),
            "depth_moulded" => $this->request->getPost('depth_moulded'),
            "draught_design" => $this->request->getPost('draught_design'),
            "draught_scantling" => $this->request->getPost('draught_scantling'),
            "hull_design" => $this->request->getPost('hull_design'),
            "top_sides" => $this->request->getPost('top_sides'),
            "bottom_sides" => $this->request->getPost('bottom_sides'),
            "flat_bottom" => $this->request->getPost('flat_bottom'),
            "dwt_cargo" => $this->request->getPost('dwt_cargo'),
            "dwt_design" => $this->request->getPost('dwt_design'),
            "dwt_scantling" => $this->request->getPost('dwt_scantling'),
            "heavy_fuel_oil" => $this->request->getPost('heavy_fuel_oil'),
            "marine_diesel_oil" => $this->request->getPost('marine_diesel_oil'),
            "marine_gas_oil" => $this->request->getPost('marine_gas_oil'),
            "lng_capacity" => $this->request->getPost('lng_capacity'),
            "lub_oil" => $this->request->getPost('lub_oil'),
            "ballast_water" => $this->request->getPost('ballast_water'),
            "fresh_water" => $this->request->getPost('fresh_water'),
            ////
            "main_engine_maker" => $this->request->getPost('main_engine_maker'),
            "main_engine_model" => $this->request->getPost('main_engine_model'),
            "main_engine_continuous_output" => $this->request->getPost('main_engine_continuous_output'),
            "main_engine_bore" => $this->request->getPost('main_engine_bore'),
            "main_engine_stroke" => $this->request->getPost('main_engine_stroke'),
            "main_engine_serial_number" => $this->request->getPost('main_engine_serial_number'),
            "main_engine_quantity" => $this->request->getPost('main_engine_quantity'),
            "auxiliary_engine_maker" => $this->request->getPost('auxiliary_engine_maker'),
            "auxiliary_engine_model" => $this->request->getPost('auxiliary_engine_model'),
            "auxiliary_engine_output" => $this->request->getPost('auxiliary_engine_output'),
            "auxiliary_engine_serial_number" => $this->request->getPost('auxiliary_engine_serial_number'),
            "auxiliary_engine_quantity" => $this->request->getPost('auxiliary_engine_quantity'),
            "emergency_generator_maker" => $this->request->getPost('emergency_generator_maker'),
            "emergency_generator_model" => $this->request->getPost('emergency_generator_model'),
            "emergency_generator_output" => $this->request->getPost('emergency_generator_output'),
            "emergency_generator_serial_number" => $this->request->getPost('emergency_generator_serial_number'),
            "emergency_generator_quantity" => $this->request->getPost('emergency_generator_quantity'),
            "shaft_generator_maker" => $this->request->getPost('shaft_generator_maker'),
            "shaft_generator_model" => $this->request->getPost('shaft_generator_model'),
            "shaft_generator_output" => $this->request->getPost('shaft_generator_output'),
            "shaft_generator_serial_number" => $this->request->getPost('shaft_generator_serial_number'),
            "shaft_generator_quantity" => $this->request->getPost('shaft_generator_quantity'),
            "propeller_maker" => $this->request->getPost('propeller_maker'),
            "propeller_type" => $this->request->getPost('propeller_type'),
            "propeller_number_of_blades" => $this->request->getPost('propeller_number_of_blades'),
            "propeller_diameter" => $this->request->getPost('propeller_diameter'),
            "propeller_pitch" => $this->request->getPost('propeller_pitch'),
            "propeller_material" => $this->request->getPost('propeller_material'),
            "propeller_weight" => $this->request->getPost('propeller_weight'),
            "propeller_output" => $this->request->getPost('propeller_output'),
            "propeller_quantity" => $this->request->getPost('propeller_quantity'),
            "bow_thruster_number" => $this->request->getPost('bow_thruster_number'),
            "bow_thruster_maker" => $this->request->getPost('bow_thruster_maker'),
            "bow_thruster_type" => $this->request->getPost('bow_thruster_type'),
            "bow_thruster_power" => $this->request->getPost('bow_thruster_power'),
            "stern_thruster_number" => $this->request->getPost('stern_thruster_number'),
            "stern_thruster_maker" => $this->request->getPost('stern_thruster_maker'),
