...
class Manufacturers extends Security_Controller {
    ...
    // import
    function import_manufacturers_modal_form() {
        return $this->template->view("manufacturers/import_manufacturers_modal_form");
    }

    function download_sample_excel_file() {
        return $this->download_app_files(get_setting("system_file_path"), serialize(array(array("file_name" => "import-manufacturers-sample.xlsx"))));
    }
    ...
    function validate_import_manufacturers_file() {
    ...
    function save_manufacturer_from_excel_file() {

        if (!$this->validate_import_manufacturers_file_data(true)) {
            echo json_encode(array('success' => false, 'message' => app_lang('error_occurred')));
        }
    ...
    function validate_import_manufacturers_file_data($check_on_submit = false) {
