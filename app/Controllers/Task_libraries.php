...
class Task_libraries extends Security_Controller {
    ...
    function save_ajax(){
        ...
        $data = array(
            ...
            "transport_to_yard_workshop"=>$this->request->getPost("transport_to_yard_workshop")?$this->request->getPost("transport_to_yard_workshop"):"",
            "crane_assistance"=>$this->request->getPost("crane_assistance"),
            "transport_outside_yard"=>$this->request->getPost("transport_outside_yard")?$this->request->getPost("transport_outside_yard"):"",
            "cleaning_before"=>$this->request->getPost("cleaning_before"),
            "material_yards_supply"=>$this->request->getPost("material_yards_supply")?$this->request->getPost("material_yards_supply"):"",
