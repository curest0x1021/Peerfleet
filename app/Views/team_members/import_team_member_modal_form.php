<?php echo form_open(get_uri("team_members/save_team_members_from_excel_file"), array("id" => "import-team_members-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-team_members-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("team_members/upload_excel_file"),
                "validation_url" => get_uri("team_members/validate_import_team_members_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("team_members/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#import-team_members-form").appForm({
            onSuccess: function () {
                location.reload();
            }
        });
        ...
        var $uploadArea = $("#upload-area"),
                ...
                $modalBody = $(".import-team_members-modal-body"),
        ...
        function addLargeModal() {
            $ajaxModal.addClass("import-team_members-app-modal");
        ...
        $submitButton.click(function () {
            $("#import-team_members-form").trigger("submit");
        });
        ...
        $nextButton.click(function () {
            ...
            appLoader.show({container: ".import-team_members-modal-body", css: "left:0;"});
            var $button = $(this);
            ...
            $.ajax({
                url: "<?php echo get_uri('team_members/validate_import_team_members_file_data') ?>",
                type: 'POST',
                dataType: 'json',
