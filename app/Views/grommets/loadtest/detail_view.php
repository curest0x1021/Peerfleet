        ...
        <div class="row clients-view-button">
            <div class="col-md-12">
                <div class="page-title clearfix no-border no-border-top-radius no-bg">
                    <h1 class="pl0"><?php echo $grommet->internal_id . " - " . app_lang("loadtest"); ?></h1>
                </div>
                    ...
                    <ul id="loadtest-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
                        ...
                        <div class="tab-title clearfix no-border">
                            <div class="title-button-group">
                                <?php echo modal_anchor(get_uri("grommets/loadtest_modal_form/" . $grommet->id), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_item'), array("class" => "btn btn-default", "title" => app_lang('add_item'), "data-post-force_refresh" => false)); ?>
                            </div>
                        </div>
                    </ul>
                    <div class="card">
