...
<div class="modal-footer">
    <?php
    echo modal_anchor(get_uri("grommets/info_modal_form/" . $model_info->client_id . "/" . $model_info->main_id), "<i data-feather='edit-2' class='icon-16'></i> " . app_lang('edit'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => app_lang('edit_item')));
    ?>
