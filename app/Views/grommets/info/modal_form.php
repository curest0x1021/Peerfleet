                ...
                <div class="col-lg-8">
                    ...
                    <div class="clearfix">
                        <div class="container-fluid">
                            ...
                            <input type="hidden" name="internal_index" value="<?php echo $internal_index; ?>" />
                            ...
                            <div class="form-group row">
                                <div class="<?php echo $label_column; ?>">
                                    <span><?php echo app_lang("wll"); ?>:</span>
                                </div>
                                <div class="<?php echo $field_column; ?>">
                                    <?php
                                    echo form_input(array(
                            ...
                            <div class="form-group row">
                                <div class="<?php echo $label_column; ?>">
                                    <span><?php echo app_lang("wl"); ?>:</span>
                                </div>
                                <div class="<?php echo $field_column; ?>">
                                    <?php
                                    echo form_input(array(
                            ...
                            <div class="form-group row">
                                <div class="<?php echo $label_column; ?>">
                                    <span><?php echo app_lang("qty"); ?>:</span>
                                </div>
                                <div class="<?php echo $field_column; ?>">
                                    <?php
                                    echo form_input(array(
                            ...
                            <div class="form-group row">
                                <div class="<?php echo $label_column; ?>">
                                    <span><?php echo app_lang("bn"); ?>:</span>
                                </div>
                                <div class="<?php echo $field_column; ?>">
                                    <?php
                                    echo form_input(array(
                                        "id" => "bn",
                                        "name" => "bn",
                                        "value" => $model_info->bn ? $model_info->bn : "",
                                        "class" => "form-control",
                                        "placeholder" => app_lang('bn'),
                                        "type" => "number",
                                        "data-rule-required" => true,
                                        "data-msg-required" => app_lang("field_required"),
                                    ));
                            ...
                            <div class="form-group row">
                                <div class="<?php echo $label_column; ?>">
                                    <span><?php echo app_lang("dia"); ?>:</span>
                                </div>
                                <div class="<?php echo $field_column; ?>">
                                    <?php
                                    echo form_input(array(
...
<script type="text/javascript">
    $(document).ready(function() {
        const internalIndex = <?php echo $internal_index; ?>;
        ...
        function generateInternalId() {
            ...
            const internalId = `G-${wll}-${wl}-${internalIndex}`;
