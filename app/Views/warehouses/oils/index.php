<div class="card">
    ...
    <div class="table-responsive">
        <table id="oils-table" class="display" cellspacing="0" width="100%">
        </table>
    </div>
</div>

<script type="text/javascript">
    loadOilsTable = function(selector) {
        $(selector).appTable({
            source: '<?php echo_uri("warehouses/oils_list_data/" . $client_id . "/" . $warehouse_id) ?>',
            columns: [
