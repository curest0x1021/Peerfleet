    ...
    <div class="tab-title clearfix">
        ...
        <?php if ($can_edit_items) { ?>
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("warehouses/import_modal_form"), "<i data-feather='upload' class='icon-16'></i> " . app_lang('import_items'), array("class" => "btn btn-default", "title" => app_lang('import_items'), "data-post-tabs" => "paints", "data-post-warehouse_id" => $warehouse_id, "data-post-client_id" => $client_id)); ?>
