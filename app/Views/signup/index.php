    ...
    <div id="page-content" class="clearfix">
        <div class="scrollable-page">
            <div class="form-signin">
                        ...
                        <?php } else { ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <label for="type_organization"
                                                class="mr15"><?php echo app_lang('organization'); ?></label>
                                            <?php
                                            echo form_radio(
                                                array(
                                                    "id" => "type_person",
                            ...
                            <div class="form-group">
                                <label for="retype_password"
                                    class="col-md-12"><?php echo app_lang('retype_password'); ?></label>
                                <div class="col-md-12">
                                    <?php
                                    echo form_password(
                                        array(
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label for="i_accept_the_terms_and_conditions">
                                            ...
                                            ?>
                                            <span
                                                class="ml10"><?php echo app_lang('i_accept_the_terms_and_conditions') . " " . anchor(get_setting("gdpr_terms_and_conditions_link"), app_lang("gdpr_terms_and_conditions") . ".", array("target" => "_blank")); ?>
                                            </span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <button class="w-100 btn btn-lg btn-primary"
                                    type="submit"><?php echo $signup_type == "send_verify_email" ? app_lang("get_started") : app_lang('signup'); ?></button>
                            </div>
                        </div>
                ...
                <div id="signin_link">
                    <?php echo app_lang("already_have_an_account") . " " . anchor("signin", app_lang("signin")); ?>
                </div>
            </div>
        </div>
    </div> <!-- /container -->
