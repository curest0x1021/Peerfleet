<?php echo form_open(get_uri("spare_parts/save_from_excel_file"), array("id" => "import-items-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-items-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("spare_parts/upload_excel_file"),
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $nextButton.click(function() {
            ...
            $.ajax({
                url: "<?php echo get_uri('spare_parts/validate_import_file_data') ?>",
                type: 'POST',
                dataType: 'json',
                data: {
                    file_name: fileName
