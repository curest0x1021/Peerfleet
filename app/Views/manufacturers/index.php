<div id="page-content" class="page-wrapper clearfix">
    <div class="row">
        <div class="col-sm-3 col-lg-2">
            <?php
            $tab_view['active_tab'] = "manufacturers";
        ...
        <div class="col-sm-9 col-lg-10">
            <div class="card">
                ...
                <div class="table-responsive">
                    <table id="manufacturer-table" class="display" cellspacing="0" width="100%">
                    </table>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#manufacturer-table").appTable({
            source: '<?php echo_uri("manufacturers/list_data") ?>',
            order: [[1, "asc"]],
            columns: [
