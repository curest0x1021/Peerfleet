...
<div class="modal-footer" >
    ...
    <button  class="btn btn-default cancel-ticket-task"  ><i data-feather="x" class="icon-16" ></i>Cancel</button>
    <button  class="btn btn-primary save-ticket-task"  ><i data-feather="check-cirlce" class="icon-16" ></i>Save</button>
</div>
<script>
    $(document).ready(function(){
        $(".cancel-ticket-task").on("click",function(){
