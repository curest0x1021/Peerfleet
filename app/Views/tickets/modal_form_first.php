...
<div id="new-ticket-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div id="link-of-new-view" class="hide">
            <?php
            echo modal_anchor(get_uri("tickets/modal_form_second"), "", array("data-modal-lg" => "1"));
            ?>
        </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary"><span data-feather="check-circle" class="icon-16"></span> <?php echo app_lang('save_continue'); ?></button>
    </div>
</div>
<?php echo form_close(); ?>
    ...
    $(document).ready(function() {
        ...
        $("#ticket-form").appForm({
            ...
            onSuccess: function(result) {
                ...
                $taskViewLink.attr("data-action-url", "<?php echo get_uri("tickets/modal_form_second"); ?>");
