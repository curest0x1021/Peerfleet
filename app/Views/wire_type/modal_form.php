<?php echo form_open(get_uri("wire_type/save"), array("id" => "wire_type-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#wire_type-form").appForm({
            onSuccess: function(result) {
                appAlert.success(result.message, {duration: 10000});
                $("#wire_type-table").appTable({ reload: true });
            }
        });
