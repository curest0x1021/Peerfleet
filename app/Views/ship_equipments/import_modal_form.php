<?php echo form_open(get_uri("ship_equipments/save_from_excel_file"), array("id" => "import-manufacturers-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-manufacturer-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("ship_equipments/upload_excel_file"),
                "validation_url" => get_uri("ship_equipments/validate_import_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("ship_equipments/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $nextButton.click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('ship_equipments/validate_import_file_data') ?>",
                type: 'POST',
                dataType: 'json',
