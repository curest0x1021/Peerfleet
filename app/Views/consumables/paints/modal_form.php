<?php echo form_open(get_uri("consumables/save_paint"), array("id" => "paint-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="unit_code" class="<?php echo $label_column; ?>"><?php echo app_lang('unit'); ?></label>
                <div class="<?php echo $field_column; ?>">
                    <?php
                    echo form_dropdown("unit_code", $units_dropdown, array($model_info->unit_code), "class='select2 validate-hidden' id='unit_code' data-rule-required='true' data-msg-required='" . app_lang('field_required') . "'");
                    ?>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        $("#paint-form").appForm({
            onSuccess: function(result) {
                ...
                $("#paint-table").appTable({newData: result.data, dataId: result.id});;
            }
        });
