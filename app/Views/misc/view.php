        ...
        <div class="row clients-view-button">
            <div class="col-md-12">
                ...
                <ul id="crane-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs title" role="tablist">
                    ...
                    <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("misc/loadtest_tab/" . $client_id); ?>" data-bs-target="#misc-loadtest"> <?php echo app_lang('loadtest') . $warnning["loadtests"]; ?></a></li>
                    <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("misc/inspection_tab/" . $client_id); ?>" data-bs-target="#misc-inspection"> <?php echo app_lang('visual_inspection') . $warnning["inspections"]; ?></a></li>
