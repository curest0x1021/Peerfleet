        ...
        <div class="row clients-view-button">
            <div class="col-md-12">
                ...
                <ul id="misc-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs title" role="tablist">
                    <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("misc/info_tab/" . $client_id . "/" . $main_id); ?>" data-bs-target="#misc-info"> <?php $main_info->item_description; ?></a></li>
