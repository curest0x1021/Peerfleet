<div id="page-content" class="page-wrapper pb0 clearfix task-view-modal-body task-preview">
    <div id="misc-info-dropzone" class="card">
        <div class="card-body">
            <div class="row">
...
<script type="text/javascript">
    $(document).ready(function() {
        var uploadUrl = "<?php echo get_uri("misc/upload_file"); ?>";
        var validationUri = "<?php echo get_uri("misc/validate_file"); ?>";

        var dropzone = attachDropzoneWithForm("#misc-info-dropzone", uploadUrl, validationUri);
