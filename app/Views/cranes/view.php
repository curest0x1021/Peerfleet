        ...
        <div class="row clients-view-button">
            <div class="col-md-12">
                ...
                <ul id="crane-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs" role="tablist">
                    ...
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("cranes/wire_inspection_tab/" . $crane->client_id); ?>" data-bs-target="#crane-wire-inspection"> <?php echo app_lang('wire_inspection'); ?></a></li>
                </ul>
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="crane-wire-inspection"></div>
                </div>
            </div>
        </div>
    </div>
