<div class="card rounded-bottom">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php echo modal_anchor(get_uri("cranes/wire_inspection_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_inspection'), array("class" => "btn btn-default", "title" => app_lang('add_inspection'), "data-post-client_id" => $client_id)); ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#wire-inspection-table").appTable({
            source: '<?php echo_uri("cranes/wire_inspection_list_data/" . $client_id) ?>',
            order: [[0, "asc"]],
            columns: [
