<?php echo form_open(get_uri("applicable_equipments/save"), array("id" => "applicable-equipment-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#applicable-equipment-form").appForm({
            onSuccess: function(result) {
                appAlert.success(result.message, {duration: 10000});
                $("#applicable-equipment-table").appTable({ reload: true });
            }
        });
