        ...
        <div class="row clients-view-button">
            <div class="col-md-12">
                ...
                <ul id="crane-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs" role="tablist">
                    ...
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("wires/inspection_tab/" . $crane->client_id); ?>" data-bs-target="#wire-inspection"> <?php echo app_lang('wire_inspection'); ?></a></li>
                </ul>
