        ...
        <div class="row clients-view-button">
            <div class="col-md-12">
                ...
                <ul id="crane-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs" role="tablist">
                    ...
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("wires/history_tab/" . $crane->client_id . "/" . $equipment->id); ?>" data-bs-target="#wire-history"> <?php echo app_lang('history') . $warnning["exchanges"]; ?></a></li>
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("wires/loadtest_tab/" . $crane->client_id . "/" . $equipment->id); ?>" data-bs-target="#wire-loadtest"> <?php echo app_lang('loadtest') . $warnning["loadtests"]; ?></a></li>
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("wires/inspection_tab/" . $crane->client_id . "/" . $equipment->id); ?>" data-bs-target="#wire-inspection"> <?php echo app_lang('visual_inspection') . $warnning["inspections"]; ?></a></li>
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("wires/certificates_tab/" . $crane->client_id . "/" . $equipment->id); ?>" data-bs-target="#wire-certificates"> <?php echo app_lang('certificates'); ?></a></li>
                </ul>
