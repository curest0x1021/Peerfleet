                    ...
                    <ul id="loadtest-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
                        ...
                        <div class="tab-title clearfix no-border">
                            <div class="title-button-group">
                                <?php echo modal_anchor(get_uri("wires/loadtest_modal_form/" . $model_info->id), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_item'), array("class" => "btn btn-default", "title" => app_lang('add_item'))); ?>
                            </div>
                        </div>
                    </ul>
                    <div class="card">
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#loadtest-detail-table").appTable({
            source: '<?php echo_uri("wires/loadtest_detail_list_data/" . $model_info->id) ?>',
            order: [[1, "desc"]],
            columns: [
