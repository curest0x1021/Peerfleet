    ...
    <div class="container-fluid">
        <div id="upload-area">
            ...
            echo view("includes/multi_file_uploader", array(
                ...
                "validation_url" => get_uri("wires/validate_import_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("wires/download_sample_excel_file/" . $tab, "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $nextButton.click(function() {
            ...
            $.ajax({
                url: "<?php echo get_uri('wires/validate_import_file_data/' . $tab) ?>",
                type: 'POST',
                dataType: 'json',
                data: {
                    file_name: fileName
