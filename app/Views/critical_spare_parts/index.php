        ...
        <div class="row clients-view-button">
            <div class="col-md-12">
                ...
                <ul id="crane-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs" role="tablist">
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("critical_spare_parts/items_tab"); ?>" data-bs-target="#critical-items"> <?php echo app_lang('critical_spare_parts'); ?></a></li>
                    <!-- <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("critical_spare_parts/units_tab"); ?>" data-bs-target="#critical-units"> <?php echo app_lang('units'); ?></a></li> -->
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade" id="critical-items"></div>
