<?php echo form_open(get_uri("clients/save_sea_valve_from_excel_file"), array("id" => "import-sea-valve-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-sea-valve-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("clients/upload_excel_file"),
                "validation_url" => get_uri("clients/validate_import_sea_valves_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("clients/download_sample_sea_valves_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var $uploadArea = $("#upload-area"),
            ...
            $modalBody = $(".import-sea-valve-modal-body"),
        ...
        function addLargeModal() {
            $ajaxModal.addClass("import-sea-valve-app-modal");
        ...
        $submitButton.click(function() {
            $("#import-sea-valve-form").trigger("submit");
        });
        ...
        $nextButton.click(function() {
            ...
            appLoader.show({
                container: ".import-sea-valve-modal-body",
                css: "left:0;"
            });
            var $button = $(this);
            ...
            $.ajax({
                url: "<?php echo get_uri('clients/validate_import_sea_valves_file_data') ?>",
                type: 'POST',
                dataType: 'json',
                data: {
                    file_name: fileName
