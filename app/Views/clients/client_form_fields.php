...
<div class="form-group">
    <div class="row">
        <label for="charter_name"
            class="<?php echo $label_column; ?> charter_name_section"><?php echo app_lang('charter_name'); ?></label>
...
<div class="form-group">
    <div class="row">
        <label for="christian_name"
            class="<?php echo $label_column; ?> christian_name_section"><?php echo app_lang('christian_name'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(
                array(
...
<div class="form-group">
    <div class="row">
        <label for="offical_number"
            class="<?php echo $label_column; ?>"><?php echo app_lang('offical_number'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(
                array(
...
<div class="form-group">
    <div class="row">
        <label for="classification_society"
            class="<?php echo $label_column; ?>"><?php echo app_lang('classification_society'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(
                array(
...
<div class="form-group">
    <div class="row">
        <label for="port_of_registry"
            class="<?php echo $label_column; ?>"><?php echo app_lang('port_of_registry'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(
                array(
