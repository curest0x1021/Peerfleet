...
$settings_menu = array(
    "general" => array(
        array("name" => "first task", "url" => "settings/general"),
        array("name" => "second task", "url" => "settings/localization"),
        array("name" => "third task", "url" => "settings/email"),
        array("name" => "another task", "url" => "email_templates"),
    ),
