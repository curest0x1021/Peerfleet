<?php echo form_open(get_uri("lifting_gear_types/save_grommet"), array("id" => "grommet-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function() {
        $("#grommet-form").appForm({
            onSuccess: function(result) {
                ...
                $("#grommet-table").appTable({newData: result.data, dataId: result.id});;
            }
        });
