<?php echo form_open(get_uri("lifting_gear_types/save_misc"), array("id" => "misc-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function() {
        $("#misc-form").appForm({
            onSuccess: function(result) {
                ...
                $("#misc-table").appTable({newData: result.data, dataId: result.id});;
            }
        });
