<?php echo form_open(get_uri("lifting_gear_types/save_lashing"), array("id" => "lashing-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function() {
        $("#lashing-form").appForm({
            onSuccess: function(result) {
                ...
                $("#lashing-table").appTable({newData: result.data, dataId: result.id});;
            }
        });
