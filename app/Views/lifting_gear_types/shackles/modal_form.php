<?php echo form_open(get_uri("lifting_gear_types/save_shackle"), array("id" => "shackle-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function() {
        $("#shackle-form").appForm({
            onSuccess: function(result) {
                ...
                $("#shackle-table").appTable({newData: result.data, dataId: result.id});;
            }
        });
