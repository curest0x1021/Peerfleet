<?php echo form_open(get_uri("lifting_gear_types/save_certificate"), array("id" => "certificate-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#certificate-form").appForm({
            onSuccess: function(result) {
                appAlert.success(result.message, {duration: 10000});
                $("#certificate-table").appTable({newData: result.data, dataId: result.id});;
            }
        });
