...
<div class="card bg-white" style="height:49vh;" id="card-tasks-overview-chart">
    ...
    <div class="card-body rounded-bottom" id="<?php echo $type; ?>-widget">
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="d-flex align-items-center justify-content-center" style="width:100%;height:30vh;;" >
                    <div  >
                        <img src="" id="all-tasks-overview-image" />
                        <canvas id="all-tasks-overview-chart-<?php echo $type; ?>" style="width: 100%; height: 160px;"></canvas>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 pl20 d-flex align-items-center <?php echo count($task_statuses) > 8 ? "" : "pt-4"; ?>">
                <div style="width:100%" >
                <?php
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        // setTimeout(() => {
        //     document.getElementById("all-tasks-overview-image").src=allTasksOverviewChart.toDataURL();
        //     allTasksOverviewChart.hidden=true;
        // }, 800);
