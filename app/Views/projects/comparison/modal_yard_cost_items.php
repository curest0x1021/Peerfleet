                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>Discount</th>
                                <th>Quote</th>
                                <th><button class="btn btn-sm btn-default btn-start-edit-panel"><i
                                            data-feather="plus-circle" class="icon-16"></i></button></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($itemList as $oneItem) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $oneItem->quantity; ?>         <?php echo $oneItem->measurement; ?> X
                                        <?php echo $oneItem->currency . " " . $oneItem->unit_price; ?> (Per unit)
                                    </td>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="quantity" name="quantity" class="form-control" value="1.0" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Measurement:</label>
                                    <input id="measurement" name="measurement" class="form-control" value="pcs" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Unit Price:</label>
                                    <input id="unit_price" name="unit_price" class="form-control" value="0.00"
                                        type="number" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input id="discount" name="discount" class="form-control" type="number" value="0.00" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Yard Remarks:</label>
                                    <textarea id="yard_remarks" name="yard_remarks" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-default btn-cancel-edit">Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $(".btn-cancel-edit").on("click", function () {
            ...
            editPanelEl.parent().parent().find(".edit-panel").prop('hidden', true);
        });
        ...
        $(".btn-save-yard-cost-item").on("click", function () {
            ...
            var editPanelEl = $(this).parent().parent().parent();
            if (!editPanelEl.find("#name")[0].value) {
                alert("Error: `Name` field is empty!");
                return;
            }
            if (!parseFloat(editPanelEl.find("#unit_price")[0].value)) {
                alert("Error: please check the `Unit Price` field!");
                return;
            }
            if (!editPanelEl.find("#quantity")[0].value) {
    ...
    var all_cost_items = [];
    <?php if (isset($allYardCostItems))
        echo 'all_cost_items=' . json_encode($allYardCostItems) . ';'; ?>
