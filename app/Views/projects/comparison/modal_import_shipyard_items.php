<div id="ajaxModalContent">
    ...
    <div class="modal-body clearfix" id="panel-import-yard-xlsx">
        <div class="container-fluid">
            ...
            <div id="upload-area-shipyard-items">
                ...
                // ));
                ?>
                <div class="d-flex justify-content-center align-items-center panel-drop-zone"
                    style="height:20vh;border:1px dashed lightgray;">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-default cancel-upload" data-bs-dismiss="modal"><span data-feather="x"
