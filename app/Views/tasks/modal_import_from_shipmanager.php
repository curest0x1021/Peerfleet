...
<div class="modal-body clearfix" id="panel-import-yard-xlsx">
    <div class="container-fluid">
        <?php echo form_open(get_uri("tasks/import_from_gl_shipmanager"), array("id" => "task-form", "class" => "general-form", "role" => "form")); ?>
        <?php echo form_close();?>
    ...
    $(document).ready(function () {
       ...
       $('#upload-area-shipmanager-xlsx').on('drag dragstart dragend dragover dragenter dragleave drop', function(e) {
        ...
        .on('drop', function(e) {
            ...
            $.ajax({
                url:"<?php echo get_uri('tasks/import_from_gl_shipmanager');?>",
                method:"POST",
                data:myForm,
