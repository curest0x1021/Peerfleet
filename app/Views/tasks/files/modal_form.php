<?php echo form_open(get_uri("tasks/upload_comment_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix" id="upload-file-panel" >
    <div class="container-fluid">
        ...
        <?php if ($model_info->id) { ?>
            ...
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("tasks/upload_file"),
                "validation_url" => get_uri("tasks/validate_task_file"),
            ));
        }
        ?>
    </div>
...
<?php } ?>
    ...
    window.upload_file_panel=$("#upload-file-panel").appForm({
        closeModalOnSuccess: success,
    })
