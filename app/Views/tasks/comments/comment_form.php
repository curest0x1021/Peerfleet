<?php
$url = "task_comments/save_comment";
$comment_type = "";
if (isset($task_id)) {
    $comment_type = "task";
    $url = "task_comments/save_comment";
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var dropzone;
<?php if ($comment_type != "file") { ?>
            var uploadUrl = "<?php echo get_uri("task_comments/upload_file"); ?>";
            var validationUrl = "<?php echo get_uri("task_comments/validate_comment_file"); ?>";
