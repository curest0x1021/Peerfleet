<?php echo form_open(get_uri("shackles/save_inspection"), array("id" => "inspection-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="client_id" value="<?php echo $shackle->client_id; ?>" />
        <input type="hidden" name="shackle_id" value="<?php echo $shackle->id; ?>" />
        <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />
        <div class="form-group">
            <div  class="col-md-12 notepad-title">
                <strong><?php echo $shackle->internal_id; ?></strong>
            </div>
        </div>
