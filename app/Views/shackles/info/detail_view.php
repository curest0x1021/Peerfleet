    ...
    <div class="container-fluid">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <span>IW - Inside Width [mm]</span>
                </div>
                <div class="form-group">
                    <span>PD - Pin Diameter [mm]</span>
                </div>
                <div class="form-group">
                    <span>IL - Inside Length [mm]</span>
                </div>
                <div class="form-group">
                    <span>Internal ID - S-WLL-Group-#</span>
                </div>
            </div>
        </div>
...
<div class="modal-footer">
    <?php
    echo modal_anchor(get_uri("shackles/info_modal_form/" . $model_info->client_id . "/" . $model_info->main_id), "<i data-feather='edit-2' class='icon-16'></i> " . app_lang('edit'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => app_lang('edit_item')));
    ?>
